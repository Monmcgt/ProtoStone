...
import me.monmcgt.code.protostone.mixin.accessor.StructurePieceAccessor;
...
/**
 * <a href="https://github.com/DeadlyMC/ProtoSky/blob/9b938afbddf9f5ad5db4099d6f5a43129ae34071/src/main/java/protosky/stuctures/StructureHelper.java">Source</a>
 */
public class StructureUtil {
    public static void genStructures(ProtoChunk protoChunk, ServerWorld world, StructureManager structureManager, ChunkGenerator generator) {
        if (world.getRegistryKey() == World.OVERWORLD) StrongholdUtil.processStronghold(world, protoChunk);
        if (world.getRegistryKey() == World.END) PillarUtil.generate(world, protoChunk);
    }
